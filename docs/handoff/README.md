...
|---|---|---|
| ESP32 post-IDF5-merge sanity | `2026-09-04-idf5-classic-validation-status.md` | Completed same-source legacy/IDF5 sanity comparison and return point for outstanding defects as normal master investigations |
