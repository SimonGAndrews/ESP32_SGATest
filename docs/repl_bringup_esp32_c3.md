...
```bash
python3 tools/esp32_c3_analog_block2.py --port /dev/ttyUSB0
```
...
```bash
python3 tools/esp32_c3_bus_spi_i2c_block3.py --port /dev/ttyUSB0
```
...
```bash
python3 tools/esp32_c3_onewire_block4.py --port /dev/ttyUSB0
```
